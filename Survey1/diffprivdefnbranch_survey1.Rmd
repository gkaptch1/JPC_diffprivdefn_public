...
```{r loading_data}
salarydata = read_csv("~/Repos/JPC_diffprivdefn_public/Survey1/salary_data_min.csv")
meddata = read_csv("~/Repos/JPC_diffprivdefn_public/Survey1/med_data_min.csv")
```
...
writetables = FALSE
writetablespath = "~/Repos/~/Repos/JPC_diffprivdefn_public/results/Survey1/tables/"
