...
writetables = FALSE
writetablespath = "../results/Survey2/tables/"
writeimagesspath = "../results/Survey2/images/"
...
if(writetables) {
  ggsave(paste(writeimagesspath,"distribution_centralcorrect.pdf",sep=""), plot=centralCorrectPlot, device=cairo_pdf)
}
```
